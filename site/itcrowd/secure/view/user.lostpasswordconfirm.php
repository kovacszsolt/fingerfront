            ...
            <div class="post-item">
                <div class="post-content-details">
                    ...
                    <div class="post-description">
                        <form id="registration_form" class="user_form" data-valid="0" method="post" data-finger_valid="0" data-name="registration">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="upper" for="email">email</label>
                                        <input type="text" class="form-control required" name="email" placeholder="email" value=""
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control required" name="newpassword" placeholder="Új jelszó" value=""
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control required" name="newpassword2" placeholder="Új jelszó megismétlése" value=""
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" class=" btn btn-success"><span>Jelszó frissítése</span></button>
                                </div>
                            </div>
