                ...
                <div class="post-content-details">
                    ...
                    <div class="post-description">
                        <form id="login_form" data-valid="0" class="user_form" method="post" action=""
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Hetente egyszer elküldjük neked e-mail-ben a hét legizgalmasabb híreit.</p>
                                    <p>Ha mégsem kéred, <a href="/hirlevellemondas/">ezen a linken</a> megtalálod a lemondás lehetőséget.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
